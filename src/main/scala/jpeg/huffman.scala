import scala.collection.immutable._
    ...
    val acChromTable = VecInit(Seq(
        ...
        (6.U, "b111000".U),  // 0/6
        (7.U, "b1111000".U),  // 0/7
        (9.U, "b111110100".U),  // 0/8
        (10.U, "b1111110110".U),  // 0/9
        (12.U, "b111111110100".U), // 0/10
        // 1
        (4.U, "b1011".U),      // 0/1
        (6.U, "b111001".U),     // 0/2
        (8.U, "b11110110".U),    // 0/3
        (9.U, "b111110101".U),   // 0/4
        (11.U, "b11111110110".U),   // 0/5
        // Additional entries for full table
        (12.U, "b111111110101".U),  // 0/6
        (16.U, "b1111111110001000".U),  // 0/7
        (16.U, "b1111111110001001".U),  // 0/8
        (16.U, "b1111111110001010".U),  // 0/9
        (16.U, "b1111111110001011".U), // 0/10
        // 2
        (5.U, "b11010".U),      // 0/1
        (8.U, "b11110111".U),     // 0/2
        (10.U, "b1111110111".U),    // 0/3
        (12.U, "b111111110110".U),   // 0/4
        (15.U, "b111111111000010".U),   // 0/5
        (16.U, "b1111111110001100".U),  // 0/6
        (16.U, "b1111111110001101".U),  // 0/7
        (16.U, "b1111111110001110".U),  // 0/8
        (16.U, "b1111111110001111".U),  // 0/9
        (16.U, "b1111111110010000".U), // 0/10
        // 3
        (5.U, "b11011".U),      // 0/1
        (8.U, "b11111000".U),     // 0/2
        (10.U, "b1111111000".U),    // 0/3
        (12.U, "b111111110111".U),   // 0/4
        (16.U, "b1111111110010001".U),   // 0/5
        (16.U, "b1111111110010010".U),  // 0/6
        (16.U, "b1111111110010011".U),  // 0/7
        (16.U, "b1111111110010100".U),  // 0/8
        (16.U, "b1111111110010101".U),  // 0/9
        (16.U, "b1111111110010110".U), // 0/10
        // 4
        (6.U, "b111010".U),      // 0/1
        (9.U, "b111110110".U),     // 0/2
        (16.U, "b1111111110010111".U),    // 0/3
        (16.U, "b1111111110011000".U),   // 0/4
        (16.U, "b1111111110011001".U),   // 0/5
        (16.U, "b1111111110011010".U),  // 0/6
        (16.U, "b1111111110011011".U),  // 0/7
        (16.U, "b1111111110011100".U),  // 0/8
        (16.U, "b1111111110011101".U),  // 0/9
        (16.U, "b1111111110011110".U), // 0/10
        // 5
        (6.U, "b111011".U),      // 0/1
        (10.U, "b1111111001".U),     // 0/2
        (16.U, "b1111111110011111".U),    // 0/3
        (16.U, "b1111111110100000".U),   // 0/4
        (16.U, "b1111111110100001".U),   // 0/5
        (16.U, "b1111111110100010".U),  // 0/6
        (16.U, "b1111111110100011".U),  // 0/7
        (16.U, "b1111111110100100".U),  // 0/8
        (16.U, "b1111111110100101".U),  // 0/9
        (16.U, "b1111111110100110".U), // 0/10
        // 6
        (7.U, "b1111001".U),      // 0/1
        (11.U, "b11111110111".U),     // 0/2
        (16.U, "b1111111110100111".U),    // 0/3
        (16.U, "b1111111110101000".U),   // 0/4
        (16.U, "b1111111110101001".U),   // 0/5
        (16.U, "b1111111110101010".U),  // 0/6
        (16.U, "b1111111110101011".U),  // 0/7
        (16.U, "b1111111110101100".U),  // 0/8
        (16.U, "b1111111110101101".U),  // 0/9
        (16.U, "b1111111110101110".U), // 0/10
        // 7
        (7.U, "b1111010".U),      // 0/1
        (11.U, "b11111111000".U),     // 0/2
        (16.U, "b1111111110101111".U),    // 0/3
        (16.U, "b1111111110110000".U),   // 0/4
        (16.U, "b1111111110110001".U),   // 0/5
        (16.U, "b1111111110110010".U),  // 0/6
        (16.U, "b1111111110110011".U),  // 0/7
        (16.U, "b1111111110110100".U),  // 0/8
        (16.U, "b1111111110110101".U),  // 0/9
        (16.U, "b1111111110110110".U), // 0/10
        // 8
        (8.U, "b11111001".U),      // 0/1
        (16.U, "b1111111110110111".U),     // 0/2
        (16.U, "b1111111110111000".U),    // 0/3
        (16.U, "b1111111110111001".U),   // 0/4
        (16.U, "b1111111110111010".U),   // 0/5
        (16.U, "b1111111110111011".U),  // 0/6
        (16.U, "b1111111110111100".U),  // 0/7
        (16.U, "b1111111110111101".U),  // 0/8
        (16.U, "b1111111110111110".U),  // 0/9
        (16.U, "b1111111110111111".U), // 0/10
        // 9
        (9.U, "b111110111".U),      // 0/1
        (16.U, "b1111111111000000".U),     // 0/2
        (16.U, "b1111111111000001".U),    // 0/3
        (16.U, "b1111111111000010".U),   // 0/4
        (16.U, "b1111111111000011".U),   // 0/5
        (16.U, "b1111111111000100".U),  // 0/6
        (16.U, "b1111111111000101".U),  // 0/7
        (16.U, "b1111111111000110".U),  // 0/8
        (16.U, "b1111111111000111".U),  // 0/9
        (16.U, "b1111111111001000".U), // 0/10
        // A
        (9.U, "b111111000".U),      // 0/1
        (16.U, "b1111111111001001".U),     // 0/2
        (16.U, "b1111111111001010".U),    // 0/3
        (16.U, "b1111111111001011".U),   // 0/4
        (16.U, "b1111111111001100".U),   // 0/5
        (16.U, "b1111111111001101".U),  // 0/6
        (16.U, "b1111111111001110".U),  // 0/7
        (16.U, "b1111111111001111".U),  // 0/8
        (16.U, "b1111111111010000".U),  // 0/9
        (16.U, "b1111111111010001".U), // 0/10
        // B
        (9.U, "b111111001".U),      // 0/1
        (16.U, "b1111111111010010".U),     // 0/2
        (16.U, "b1111111111010011".U),    // 0/3
        (16.U, "b1111111111010100".U),   // 0/4
        (16.U, "b1111111111010101".U),   // 0/5
        (16.U, "b1111111111010110".U),  // 0/6
        (16.U, "b1111111111010111".U),  // 0/7
        (16.U, "b1111111111011000".U),  // 0/8
        (16.U, "b1111111111011001".U),  // 0/9
        (16.U, "b1111111111011010".U), // 0/10
        // C
        (9.U, "b111111010".U),      // 0/1
        (16.U, "b1111111111011011".U),     // 0/2
        (16.U, "b1111111111011100".U),    // 0/3
        (16.U, "b1111111111011101".U),   // 0/4
        (16.U, "b1111111111011110".U),   // 0/5
        (16.U, "b1111111111011111".U),  // 0/6
        (16.U, "b1111111111100000".U),  // 0/7
        (16.U, "b1111111111100001".U),  // 0/8
        (16.U, "b1111111111100010".U),  // 0/9
        (16.U, "b1111111111100011".U), // 0/10
        // D
        (11.U, "b11111111001".U),      // 0/1
        (16.U, "b1111111111100100".U),     // 0/2
        (16.U, "b1111111111100101".U),    // 0/3
        (16.U, "b1111111111100110".U),   // 0/4
        (16.U, "b1111111111100111".U),   // 0/5
        (16.U, "b1111111111101000".U),  // 0/6
        (16.U, "b1111111111101001".U),  // 0/7
        (16.U, "b1111111111101010".U),  // 0/8
        (16.U, "b1111111111101011".U),  // 0/9
        (16.U, "b1111111111101100".U), // 0/10
        // E
        (14.U, "b11111111100000".U),      // 0/1
        (16.U, "b1111111111101101".U),     // 0/2
        (16.U, "b1111111111101110".U),    // 0/3
        (16.U, "b1111111111101111".U),   // 0/4
        (16.U, "b1111111111110000".U),   // 0/5
        (16.U, "b1111111111110001".U),  // 0/6
        (16.U, "b1111111111110010".U),  // 0/7
        (16.U, "b1111111111110011".U),  // 0/8
        (16.U, "b1111111111110100".U),  // 0/9
        (16.U, "b1111111111110101".U), // 0/10
        // F
        (15.U, "b111111111000011".U),      // 0/1
        (16.U, "b1111111111110110".U),     // 0/2
        (16.U, "b1111111111110111".U),    // 0/3
        (16.U, "b1111111111111000".U),   // 0/4
        (16.U, "b1111111111111001".U),   // 0/5
        (16.U, "b1111111111111010".U),  // 0/6
        (16.U, "b1111111111111011".U),  // 0/7
        (16.U, "b1111111111111100".U),  // 0/8
        (16.U, "b1111111111111101".U),  // 0/9
        (16.U, "b1111111111111110".U), // 0/10
    ))
/**
